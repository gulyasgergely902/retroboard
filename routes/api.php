...
Route::delete('/boards', function(Request $request){
...
Route::post('/stickies', function(Request $request){
    $validateFormData = $request->validate([
...
Route::delete('/stickies', function(Request $request){
...
Route::delete('/groups', function(Request $request){
